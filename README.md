...
- `git clone https://github.com/erickbxs/Typescript-Trybesmith-Server.git`.
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
  ...
  - Exemplo: `git checkout -b joaozinho-project-trybesmith`
...
- Faça o `commit` inicial
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-project-trybesmith`
